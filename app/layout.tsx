...
export const metadata: Metadata = {
  ...
  description,
  icons: {
    icon: [{ url: `${siteUrl}/favicon-rounded.png`, type: "image/png", sizes: "256x256" }],
    shortcut: `${siteUrl}/favicon-rounded.png`,
    apple: [{ url: `${siteUrl}/favicon-rounded.png`, type: "image/png", sizes: "256x256" }],
  },
  openGraph: {
    title,
    description,
